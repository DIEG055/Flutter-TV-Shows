...
class SeasonDetailspage extends StatelessWidget {
  ...
  final SeasonModel seasonData  = arguments["season"];
  final TvShowProvider provider = TvShowProvider();
  final seasonInfo              = provider.getSeasonById(arguments["showId"],seasonData.seasonNumber);
                  ...
                  FutureBuilder(
                    ...
                    builder: (context, AsyncSnapshot<SeasonModel> snapshot){
                      if(snapshot.hasData){
                        ...
                        return _episodesInfo(season,context);                                   
                      }else{
                        return Container(
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ...
                    Text( season.episodeCount.toString(), style: Theme.of(context).textTheme.subtitle1 )
                  ],
                )
              ],
            ),
  ...
  _episodesInfo(SeasonModel season, BuildContext context) {
  ...
  return Container(
      ...
      child: Column(
        ...
        return  GestureDetector(
          child: showItem,
          onTap: (){
            Navigator.pushNamed(context, 'episodeDetails', arguments: episode);
          },
    );
      }).toList(),
        )
